...
### 5-1. 다크 모드
- [x] Tailwind `darkMode: 'media'` 설정
- [x] 사이드바 다크 모드 색상 적용
- [x] 메인 영역 다크 모드 색상 적용
- [x] 카드/모달/입력 필드 다크 모드 색상 적용
- [x] spec.md 색상표 준수 확인

### 5-2. 반응형 디자인
- [x] `>=1024px`: 사이드바 항상 표시
- [x] `768px~1023px`: 햄버거 버튼으로 사이드바 접기/펼치기
- [x] `<768px`: 사이드바 오버레이 + 메인 전체 너비

### 5-3. 애니메이션 마무리
- [x] 리스트 전환 fade (0.2s)
- [x] 모달 scale + opacity (0.2s)
- [x] 사이드바 호버 배경색 전환 (0.15s ease)
- [x] 리마인더 삭제 slide-out

### 5-4. 에러 핸들링
- [x] 빈 상태 UI (리마인더 없을 때 placeholder)

### 5-5. 검증
- [x] 다크 모드 전환 시 전체 컴포넌트 색상 확인
- [x] 다양한 화면 크기 레이아웃 확인 (Chrome DevTools)
- [x] 전체 기능 회귀 테스트
